...
const PrivacyPolicyPage = () => {
  return (
    <Container maxWidth="md" style={{ marginTop: '180px', marginBottom: '50px' }}>
      ...
      This Privacy Policy describes how wespray.myshopify.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.
      </Typography>

      <Typography variant="body1" sx={{ mt: 2, textAlign: 'justify' }}>
        <b>Contact</b>
        <br />
        After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at lala.lechat@outlook.com or by mail using the details provided below:

37 Rue du Clos de la Cerisaie, 34000 Montpellier, France
      </Typography>
...
We may share your Personal Information to comply with applicable laws and regulations, to respond to a subpoena, search warrant or other lawful request for information we receive, or to otherwise protect our rights.      </Typography>
...
Temporary blacklist of credit cards associated with blacklisted IP addresses. This blacklist persists for a small number of days.      </Typography>
...
If you are not satisfied with our response to your complaint, you have the right to lodge your complaint with the relevant data protection authority. You can contact your local data protection authority, or our supervisory authority here: no where.
      </Typography>
